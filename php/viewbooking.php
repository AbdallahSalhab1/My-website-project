...
foreach($data as $row){
    ...
    echo 'flight destination '. $row['destination']. '</br> startingdate '.  $row['startingdate']. '</br> number of days '. $row['num_of_days'];
}
...
<body>
        ...
        <form action="editbooking.php" method="POST">
            <h2>editing a flight</h2>
    
        <h2>please edit your flights information</h2>
        <lable for="destination">Select your desierd destination:</lable><br>
        <input list="destination" name="destination" value="<?php echo $destination?>">
    ...
    <option value="ZW">Zimbabwe</option>
        ...
        <lable for="date">Trip starting date:</lable><br><input type="date" id="date" name="startingdate" value="<?php echo $startingdate?>"><br>
        <lable for="days">Number of days:</lable><br><input type="number" id="days" name="num_of_days" value="<?php echo $num_of_days?>" placeholder="Enter the number of days"><br>
        <input type="hidden" name="id" value="<?php echo $id?>">
        <button type="submit" name="update" value="edit">edit</button><br>
    </form>
            
    
    <footer>
        <a href="viewallbookings.php"></a>
    </footer>
</div>
</body>
</html>